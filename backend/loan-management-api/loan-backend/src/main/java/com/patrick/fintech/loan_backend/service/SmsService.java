...
public class SmsService {
    ...
    public void sendLoanApproved(Loan loan) {
        ...
        send(
                phone,
                String.format(
                        "Congratulations! Loan %s for %s %s approved. "
                                + "Funds disbursed shortly. -%s",
    ...
    public void sendLoanDisbursed(
        ...
        send(
                phone,
                String.format(
                        "Funds sent! %s %s for loan %s has been "
                                + "disbursed via %s. -%s",
    ...
    public void sendPaymentDue(
        ...
        send(
                phone,
                String.format(
                        "REMINDER: Payment of %s %s due %s "
                                + "for loan %s. Pay now to avoid "
                                + "penalties. -%s",
    ...
    /**
     * Twilio and most SMS gateways require E.164 format.
     *
     * Examples:
     *
     * 0788000000
    ...
    private boolean trySendAT(
        ...
        try {
            ...
            log.debug(
                    "SMS sent via Africa's Talking to {}",
                    to
            );
    ...
    /**
     * Financial fields in Loan are BigDecimal.
     *
     * This method is therefore the primary formatter used by
     * SMS messages.
     */
    private String fmt(
            BigDecimal value) {
    ...
    /**
     * Kept for existing methods such as:
     *
     * sendPaymentDue(...)
     * sendPaymentConfirmed(...)
     *
     * which currently receive double amounts.
     */
    private String fmt(
            Double value) {
    ...
    private String phone(
        ...
        if (loan == null
                ...
                || loan.getBorrower().getPhone().isBlank()) {

            return null;
        }

        return loan.getBorrower().getPhone();
    }
    ...
    private String orgName(
        ...
        return loan.getOrganization().getName();
    }
}
