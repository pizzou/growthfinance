...
@Table(
    ...
    indexes = {
        @Index(
            name = "idx_payment_tx_loan",
            columnList = "loan_id"
        ),
        @Index(
            name = "idx_payment_tx_installment",
            columnList = "installment_id"
        ),
        @Index(
...
public class PaymentTransaction {
    ...
    @Builder.Default
    private Double penaltyComponent = 0.0;
    ...
    @Builder.Default
    private Double unappliedAmount = 0.0;
